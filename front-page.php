    ...
    <div class="ergo-container">
        <div class="gl-sections__grid">
            ...
            $cards = array(
                ...
                array( 'icon' => 'dashicons-admin-site-alt3',  'title' => 'Страны',           'desc' => 'Обзор всех стран с детальной статистикой.',                                                       'url' => WorldStat_Pages::get_page_url( 'countries' ),             'color' => '#8b5cf6' ), //на countries, чтобы открывалась сетка стран
...
<section class="gl-analytics-dashboard">
    <div class="ergo-container">
        ...
        <div class="gl-analytics-grid">
            ...
            <!-- Большой блок — Рейтинги стран (слева) -->
            <a href="<?php echo esc_url( WorldStat_Pages::get_page_url( 'rankings' ) ); ?>" 
               class="gl-analytics-card gl-analytics-card--large" 
               style="--card-accent: #f59e0b;">
                ...
                <div class="gl-analytics-card__content">
                    ...
                    <p class="gl-analytics-card__desc">Сравнивайте страны по населению, площади, ВВП и десяткам других показателей из разных источников</p>
                    <ul class="gl-analytics-card__features">
                        <li>📊 Топ-5 лидеров по любой метрике</li>
                        <li>🌍 Фильтр по регионам и субрегионам</li>
                        <li>📋 Детальная таблица до 100 стран</li>
                    </ul>
                    <span class="gl-analytics-card__action">Перейти к рейтингам →</span>
                </div>
            </a>

            <!-- Колонка из 4 маленьких блоков (справа) -->
            <div class="gl-analytics-small-col">
                
                <a href="<?php echo esc_url( WorldStat_Pages::get_page_url( 'map-explorer' ) ); ?>" 
                   class="gl-analytics-card gl-analytics-card--small" 
                   style="--card-accent: #06b6d4;">
                    ...
                    <div class="gl-analytics-card__content">
                        ...
                        <p class="gl-analytics-card__desc">Хороплеты и слои данных по странам мира</p>
                    </div>
                </a>

                <a href="<?php echo esc_url( WorldStat_Pages::get_page_url( 'methodology' ) ); ?>" 
                class="gl-analytics-card gl-analytics-card--small" 
                style="--card-accent: #10b981;">
                    <span class="gl-analytics-card__icon">📖</span>
                    <div class="gl-analytics-card__content">
                        <strong class="gl-analytics-card__title">Методология</strong>
                        <p class="gl-analytics-card__desc">Методы расчёта, источники и даты обновления данных</p>
                    </div>
                </a>

                <a href="<?php echo esc_url( WorldStat_Pages::get_page_url( 'data-panel' ) ); ?>" 
                   class="gl-analytics-card gl-analytics-card--small" 
                   style="--card-accent: #8b5cf6;">
                    <span class="gl-analytics-card__icon">🧪</span>
                    <div class="gl-analytics-card__content">
                        <strong class="gl-analytics-card__title">Песочница данных</strong>
                        <p class="gl-analytics-card__desc">Матрица стран × метрик с экспортом в CSV</p>
                    </div>
                </a>

                <a href="<?php echo esc_url( WorldStat_Pages::get_page_url( 'metrics-catalog' ) ); ?>" 
                   class="gl-analytics-card gl-analytics-card--small" 
                   style="--card-accent: #6366f1;">
                    <span class="gl-analytics-card__icon">📋</span>
                    <div class="gl-analytics-card__content">
                        <strong class="gl-analytics-card__title">Каталог метрик</strong>
                        <p class="gl-analytics-card__desc">Все показатели платформы с поиском и фильтрами</p>
                    </div>
                </a>
    ...
    <div class="ergo-container">
        <div class="gl-three-cols__grid">
            ...
            <div class="gl-three-cols__col">
                ...
                <a href="<?php echo esc_url( home_url( '/glossariy/' ) ); ?>" class="gl-three-cols__more">Перейти &rarr;</a>
            </div>
            <!-- Ссылки -->
            <div class="gl-three-cols__col">
